...
(custom-set-faces
  `(font-lock-function-name-face ((t (:foreground ,(doom-color 'orange)))))
  `(font-lock-function-call-face ((t (:foreground ,(doom-color 'violet)))))
  `(font-lock-delimiter-face ((t (:foreground ,(doom-color 'white)))))
  `(font-lock-type-face ((t (:foreground ,(doom-color 'green)))))
  `(font-lock-keyword-face ((t (:foreground ,(doom-color 'yellow)))))
  `(font-lock-variable-name-face ((t (:foreground ,(doom-color 'base7)))))
  `(font-lock-variable-use-face ((t (:foreground ,(doom-color 'cyan)))))
  `(font-lock-property-use-face ((t (:foreground ,(doom-color 'base7)))))
  `(font-lock-preprocessor-face ((t (:foreground ,(doom-color 'dark-green)))))
  )
;;; gruvbox-theme.el ends her
